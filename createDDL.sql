CREATE TABLE POSITION (IDPOSITION BIGINT NOT NULL AUTO_INCREMENT, LATITUTE FLOAT, LONGITUDE FLOAT, PRIMARY KEY (IDPOSITION))
CREATE TABLE TRAJET (IDTRAJET BIGINT NOT NULL AUTO_INCREMENT, DATE DATETIME, ARRIVEE_IDPOSITION BIGINT, CONDUCTEUR_IDUSER BIGINT, DEPART_IDPOSITION BIGINT, VOITURE_IDVOITURE BIGINT, PRIMARY KEY (IDTRAJET))
CREATE TABLE USER (IDUSER BIGINT NOT NULL AUTO_INCREMENT, CENTRESINTERET LONGBLOB, EMAIL VARCHAR(255), MDP VARCHAR(255), PREFERENCES LONGBLOB, POSITION_IDPOSITION BIGINT, PRIMARY KEY (IDUSER))
CREATE TABLE VOITURE (IDVOITURE BIGINT NOT NULL AUTO_INCREMENT, ANNEE INTEGER, MODELE VARCHAR(255), NBPLACES INTEGER, PRIMARY KEY (IDVOITURE))
